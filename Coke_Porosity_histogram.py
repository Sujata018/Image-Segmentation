...
'''
Program for porosity calculation of a coke image, using openCV, skimage and shapely
'''
...
Parameters used:
        ...
        kernel     : disk(10). Increase 10 if more effects required for open and close operations.
'''
if __name__=='__main__':
    ...
    for i in range(len(file)):
        ...
        ohimgi=np.where(himg<thresh,255,0)           # based on Otsu threshold, create negative binary image
